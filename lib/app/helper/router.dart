...
import 'package:salon_user/app/backend/binding/common_notitifcation_binding.dart';
...
import 'package:salon_user/app/backend/binding/qr_binding.dart';
...
import 'package:salon_user/app/view/filter_cat.dart';
...
import 'package:salon_user/app/view/notification.dart';
...
class AppRouter {
  ...
  static const String filterRoutesCat = '/filter_cat';
  ...
  static const String productsSubcategoriesRoutes =
      '/productsSubcategoriesRoutes';
  ...
  //static const String notificationRoutes = '/notification';
  static const String qrcode = '/qrcode';

  static const String commonNotification = '/commonNotification';
  ...
  static String getFilterRoutesCat() => filterRoutesCat;
  ...
  static String getProductsSubcategoriesRoutes() => productsSubcategoriesRoutes;
  ...
  // static String getNotificatinRoutes() => notificationRoutes;
  ...
  static String getQr() => qrcode;
  static String getNotificatinRoutes() => commonNotification;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: qrcode, page: () => const QRViewExample(), binding: QrBinding()),
    ...
    GetPage(
        ...
        binding: CommonNotificationPageBinding()),
    GetPage(
        name: welcome,
    ...
    GetPage(
        name: getFilterRoutesCat(),
        page: () => const FilterScreenCat(),
        binding: FilterBinding(),
        fullscreenDialog: true),
    GetPage(
        name: searchRoutes,
    ...
    GetPage(
        name: productsSubcategoriesRoutes,
    ...
    GetPage(
        name: rescheduleslotRoutes,
        page: () => const RescheduleSlotScreen(),
        binding: RescheduleSlotBinding()),
    GetPage(
        name: paymentRoutes,
