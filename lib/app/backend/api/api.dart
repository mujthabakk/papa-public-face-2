...
class ApiService extends GetxService {
  ...
  Future<Response> getPrivate(String uri, String token) async {
    try {
      http.Response response = await httpp.get(Uri.parse(appBaseUrl + uri),
          headers: {
  ...
  Future<Response> postPrivate(
    ...
    try {
      http.Response response = await httpp.post(Uri.parse(appBaseUrl + uri),
          body: jsonEncode(body),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $token'
