  ...
  void sortProducts(String criteria) {
    ...
    switch (criteria) {
      case 'rating':
        ...
        break;
      case 'low_to_high':
        _productsList.sort((a, b) => a.sellPrice!.compareTo(b.sellPrice!));
        break;
      case 'high_to_low':
        _productsList.sort((a, b) => b.sellPrice!.compareTo(a.sellPrice!));
        break;
      case 'a_to_z':
        _productsList.sort((a, b) => a.name!.compareTo(b.name!));
        break;
      case 'z_to_a':
        _productsList.sort((a, b) => b.name!.compareTo(a.name!));
        break;
      case 'discount':
        _productsList.sort((a, b) => b.discount!.compareTo(a.discount!));
        break;
    }
