...
//                                                                             FadeInImage(
//                                                                           image:
//                                                                               NetworkImage('${Environments.imageURL}${value.savedInCart.packages![i].specialist![specialistIndex].cover}'),
//                                                                           placeholder:
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget _buildServicesList(CheckoutController value) {
    return Column(
      children: List.generate(
  ...
  Widget _buildServiceItem(CheckoutController value, int index) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        Get.find<CheckoutController>().currencySide == 'left'
                            ? '${Get.find<CheckoutController>().currencySymbol}${service.price}'
                            : '${service.price}${Get.find<CheckoutController>().currencySymbol}',
                        style: const TextStyle(
                          fontSize: 12,
                          color: textSecondary,
                      ...
                      Text(
                        Get.find<CheckoutController>().currencySide == 'left'
                            ? '${Get.find<CheckoutController>().currencySymbol}${service.off}'
                            : '${service.off}${Get.find<CheckoutController>().currencySymbol}',
                        style: const TextStyle(
                          fontSize: 14,
  ...
  Widget _buildPackagesList(CheckoutController value) {
    return Column(
      children: List.generate(
  ...
  Widget _buildPackageItem(CheckoutController value, int index) {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
                        ...
                        children: [
                          Text(
                            Get.find<CheckoutController>().currencySide ==
                                    'left'
                                ? '${Get.find<CheckoutController>().currencySymbol}${package.price}'
                                : '${package.price}${Get.find<CheckoutController>().currencySymbol}',
                            style: const TextStyle(
                              fontSize: 12,
                              color: textSecondary,
                              decoration: TextDecoration.lineThrough,
                          ...
                          Text(
                            Get.find<CheckoutController>().currencySide ==
                                    'left'
                                ? '${Get.find<CheckoutController>().currencySymbol}${package.off}'
                                : '${package.off}${Get.find<CheckoutController>().currencySymbol}',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w700,
                              color: success,
            ...
            // Specialists
            if (package.specialist != null &&
                package.specialist!.isNotEmpty) ...[
              const SizedBox(height: 12),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  _buildSpecialistAvatars(package.specialist!),
                ],
              ),
            ],
          ],
  ...
  // Widget _buildSpecialistAvatars(List specialists) {
  //   return SizedBox(
  //     height: 32,
  //     child: Stack(
  //       children: List.generate(
  //         specialists.take(4).length,
  //         (index) => Positioned(
  //           right: index * 20.0,
  //           child: Container(
  //             width: 32,
  ...
  //               child: FadeInImage(
  //                 image: NetworkImage(
  //                     '${Environments.imageURL}${specialists[index].cover}'),
  //                 placeholder:
  //                     const AssetImage("assets/images/placeholder.jpeg"),
  //                 imageErrorBuilder: (context, error, stackTrace) {
  //                   return Image.asset('assets/images/notfound.png',
  ...
  Widget _buildSpecialistAvatars(List specialists) {
    final int avatarCount = specialists.take(4).length;
    final double stackWidth =
        32 + (avatarCount - 1) * 20.0; // Calculate width dynamically

    return SizedBox(
      height: 32,
      width: stackWidth, // Set explicit width
      child: Stack(
        children: List.generate(
          avatarCount,
          (index) => Positioned(
  ...
  Widget _buildBillDetailsCard(CheckoutController value) {
    return Container(
      decoration: BoxDecoration(
        color: cardBackground,
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildBottomButton(CheckoutController value) {
    return Container(
      decoration: BoxDecoration(
        color: cardBackground,
        boxShadow: const [
