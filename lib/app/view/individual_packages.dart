...
class _IndividualPackagesScreenState extends State<IndividualPackagesScreen> {
  ...
  Widget _buildPackageDetails(IndividualPackagesController controller) {
    return Column(
      children: [
        _buildDetailRow(
          Icons.assignment,
  ...
  Widget _buildPriceRow(IndividualPackagesController controller) {
    return Container(
      padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
      decoration: BoxDecoration(
...
Widget _buildServicesList(IndividualPackagesController controller) {
  return Column(
...
Widget _buildGallery(IndividualPackagesController controller) {
  return SizedBox(
    height: 100,
...
Widget _buildBottomNavBar(IndividualPackagesController controller) {
